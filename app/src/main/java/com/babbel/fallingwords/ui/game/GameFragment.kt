...
import com.babbel.fallingwords.ui.MainViewModel
...
class GameFragment : Fragment() {
    ...
    private fun initObserver() {
        ...
        viewModel.userSelectedAnswer.observe(viewLifecycleOwner, Observer {
            ...
            viewModel.getSession()
            when (it) {
                Constant.CORRECT -> img_answer.setImageResource(R.drawable.ic_correct)
                Constant.WRONG -> img_answer.setImageResource(R.drawable.ic_wrong)
                Constant.UNATTEMPTED -> img_answer.setImageResource(R.drawable.ic_wrong)
                else -> {}
            }
        ...
        viewModel.session.observe(viewLifecycleOwner, Observer { session ->
            ...
            score.text = String.format(getString(R.string.text_score), session?.correct)
        })
    ...
    private fun startFallingAnswer() {
        falling_word.visibility = View.VISIBLE
        falling_word.text = viewModel.activeWord.value?.translatedWord
