...
import com.babbel.fallingwords.util.UserResponse
...
class MainViewModelTest {
    ...
    val fakeCorrectWord =
        Word(text_eng = "English", text_spa = "Spanish", translatedWord = "Spanish")
    val fakeWrongWord =
        Word(text_eng = "English", text_spa = "Spanish", translatedWord = "German")
